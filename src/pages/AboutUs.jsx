          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="w-full lg:w-1/3 text-center space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed text-base">
                Sneaker story began with a love for sneakers. We've evolved into a hub for
                innovation, style, and community — uniting enthusiasts globally with our curated
                selection and passion-driven approach.
              </p>
